...
public class SendMailUtils {
	...
	public SendMailUtils(String to, String from, String host, String username,
	...
	public static void main(String[] args) {
		...
		mail.setTo("liangxiaofei1100@163.com");
		mail.setFrom("zhaoyantech@163.com");// 你的邮箱
		mail.setHost("smtp.163.com");
		mail.setUsername("zhaoyantech@163.com");// 用户
		mail.setPassword("******");// 密码
		mail.setSubject("send mail test");
		mail.setContent("content send mail test.");
		if (mail.sendMail()) {
